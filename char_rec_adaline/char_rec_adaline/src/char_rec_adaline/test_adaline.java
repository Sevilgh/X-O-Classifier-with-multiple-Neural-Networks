...
public class test_adaline {
	...
	public static void main(String[] args) {
		...
		shllCharacterRecognition.setSize(751, 613);
		shllCharacterRecognition.setText("ADALINE CHARACTER RECOGNITION");
		...
		btnRec.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				adaline adaline_rec=new adaline();
				String recognized=adaline_rec.main(x,m);
