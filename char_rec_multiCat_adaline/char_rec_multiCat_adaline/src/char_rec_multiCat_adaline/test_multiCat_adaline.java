...
public class test_multiCat_adaline {
	private static Shell shllCharacterRecognition;
	...
	public static void main(String[] args) {
		...
		shllCharacterRecognition = new Shell();
		shllCharacterRecognition.setBackground(SWTResourceManager.getColor(SWT.COLOR_INFO_BACKGROUND));
		shllCharacterRecognition.setTouchEnabled(true);
		shllCharacterRecognition.setSize(829, 613);
		shllCharacterRecognition.setText("Multi-Category ADALINE CHARACTER RECOGNITION");
		
		
		Label lblResult = new Label(shllCharacterRecognition, SWT.NONE);
		lblResult.setBackground(SWTResourceManager.getColor(SWT.COLOR_INFO_BACKGROUND));
		lblResult.setFont(SWTResourceManager.getFont("Segoe Print", 19, SWT.BOLD));
		lblResult.setBounds(536, 432, 265, 61);
		
		
		Button button_0 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_1 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_2 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_3 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_4 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_5 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_6 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_7 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_8 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_9 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_10 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_11 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_12 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_13 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_14 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_15 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_16 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		int m=1000;
		Button button_17 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_18 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_19 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_20 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_21 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_22 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_23 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button button_24 = new Button(shllCharacterRecognition, SWT.NONE);
		...
		Button btnRec = new Button(shllCharacterRecognition, SWT.NONE);
		...
		btnRec.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				multiCat_adaline multi_rec=new multiCat_adaline();
				String recognized=multi_rec.main(x,m);
				lblResult.setText(recognized);
			}
		});
		btnRec.setBounds(536, 336, 200, 90);
		btnRec.setText("recognize");
		
		Button btnClear = new Button(shllCharacterRecognition, SWT.NONE);
		...
		btnClear.setBounds(536, 240, 200, 90);
		
	
		

		shllCharacterRecognition.open();
		shllCharacterRecognition.layout();
		while (!shllCharacterRecognition.isDisposed()) {
