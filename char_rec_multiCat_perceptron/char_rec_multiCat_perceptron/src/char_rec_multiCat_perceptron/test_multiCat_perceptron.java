...
public class test_multiCat_perceptron {
	private static Shell shlCharacterRecognition;
	...
	public static void main(String[] args) {
		...
		shlCharacterRecognition = new Shell();
		shlCharacterRecognition.setBackground(SWTResourceManager.getColor(SWT.COLOR_INFO_BACKGROUND));
		shlCharacterRecognition.setTouchEnabled(true);
		shlCharacterRecognition.setSize(829, 613);
		shlCharacterRecognition.setText("Multi-Category PERCEPTRON CHARACTER RECOGNITION");
		
		
		Label lblResult = new Label(shlCharacterRecognition, SWT.NONE);
		...
		lblResult.setBounds(536, 432, 236, 61);
		
		
		Button button_0 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_1 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_2 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_3 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_4 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_5 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_6 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_7 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_8 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_9 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_10 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_11 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_12 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_13 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_14 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_15 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_16 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_17 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_18 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_19 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_20 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_21 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_22 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_23 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button button_24 = new Button(shlCharacterRecognition, SWT.NONE);
		...
		Button btnRec = new Button(shlCharacterRecognition, SWT.NONE);
		...
		btnRec.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				multiCat_perceptron25 multi_rec=new multiCat_perceptron25();
				String recognized=multi_rec.main(x);
		...
		Button btnClear = new Button(shlCharacterRecognition, SWT.NONE);
		...
		shlCharacterRecognition.open();
		shlCharacterRecognition.layout();
		while (!shlCharacterRecognition.isDisposed()) {
