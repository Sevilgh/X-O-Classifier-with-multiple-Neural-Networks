...
public class test_perceptron {
	...
	public static void main(String[] args) {
		...
		shllCharacterRecognition.setSize(763, 613);
		shllCharacterRecognition.setText("PERCEPTRON CHARACTER RECOGNITION");
		...
		lblResult.setBounds(546, 432, 185, 61);
		...
		btnRec.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				perceptron25 perceptron_rec=new perceptron25();
				String recognized=perceptron_rec.main(x);
